...
measured_FK = np.array([
     ...
     0.103,                        # <- check below for more info
...
optimized_FK = measured_FK

# 2021 Sep 16
optimized_FK = np.array([
-0.00206070984203802739, 0.00000000000000000000, 0.10214935771604945203, 0.01225473078059401665,
 1.57351669901182389388, 0.00000000000000000000, 0.08261999663777491731, -0.02093436802834319418,
 3.14159461252278537913, 0.32597376478258538457, 0.04507690047547738971, -0.00000028783177055450,
 3.14154631443402099222, 0.32749904933125784101, 0.07130312306213977547, 0.00148693080080850113,
 1.57079496747256208700, 0.00000000000000000000, 0.11425467845679478096, -0.00036789007464090023,
 1.57079620991836543809, 0.00000000000000000000, 0.11538854041186309696, 0.00000274172995033874,
 -0.70699999999999996181, 0.00000000000000000000, 0.00000000000000000000, 0.70699999999999996181,
 0.11980345236366839179, 0.07706233107273240124, 0.02608854041205015822])
...
def get_fk_tips(list_jp, FK_params):
  DH_params = np.reshape(FK_params[:-7], (6,4)) # each link is represented by 4 params
